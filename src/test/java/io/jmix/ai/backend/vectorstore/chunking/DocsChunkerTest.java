...
public class DocsChunkerTest {
    ...
    public static final String DOC_PATH = "Concepts > Web Development Fundamentals";
    public static final String START = "Path: " + DOC_PATH;

    @Test
    void testComplexDocumentFits() throws IOException {
        DocsChunker chunker = new DocsChunker(10_000, 10, 10);
        List<Chunker.Chunk> chunks = chunker.extract(loadResourceAsString("/test_support/sources/doc-1.html"), DOC_PATH);
