...
/**
 * Compared to the original VectorStoreDocumentRetriever, this class offers
 * the {@link #getRetrievedDocuments()} method to access the list of retrieved documents.
 *
 * <p>
 ...
 * @since 1.0.0
 */
public final class CustomDocumentRetriever implements DocumentRetriever {
	...
	public CustomDocumentRetriever(VectorStore vectorStore, @Nullable Double similarityThreshold,
	...
	/**
	 * The list of documents obtained during the retrieval process.
	 */
	...
	public List<Document> retrieve(Query query) {
		...
		retrievedDocuments = documents == null ? new ArrayList<>() : documents;
		return documents;
	}
	...
	/**
	 * Builder for {@link CustomDocumentRetriever}.
	 */
	public static final class Builder {
		...
		public CustomDocumentRetriever build() {
			return new CustomDocumentRetriever(this.vectorStore, this.similarityThreshold, this.topK,
